use crate::events::FillClaimedCollectionAssetDistributionEvent;
use crate::states::{
...
use crate::utils::{
    check_back_authority, check_is_auction_is_locked, check_is_distribution_full,
    check_is_exceeding_end_index, check_is_program_working,
    check_program_id, check_signer_exist, try_get_remaining_account_info,
};
...
pub struct FillClaimedCollectionAssetDistributionInputParams {
    pub pad_name: String,
    ...
    pub user_collection_auction_unsold_distribution_config_bump: u8,
}

#[derive(Accounts)]
#[instruction(params: FillClaimedCollectionAssetDistributionInputParams)]
pub struct FillClaimedCollectionAssetDistributionInputAccounts<'info> {
    #[account(mut)]
    ...
    #[account(
       mut,
        ...
        bump = params.user_collection_auction_unsold_distribution_config_bump,
    )]
...
pub fn handle_fill_claimed_collection_asset_distribution<'info>(
    ctx: Context<'_, '_, 'info, 'info, FillClaimedCollectionAssetDistributionInputAccounts<'info>>,
    ...
    let user_collection_auction_unsold_distribution_config: &Box<
    ...
    collection_auction_config.current_index = collection_auction_config
        ...
        .checked_add(1)
        .unwrap();
    collection_auction_config.total_unsold_supply_distribution_claimed_filled =
        collection_auction_config
            .total_unsold_supply_distribution_claimed_filled
            .checked_add(1)
            .unwrap();
    ...
    user_collection_auction_unsold_distribution_config.amount_filled =
        user_collection_auction_unsold_distribution_config
            .amount_filled
            .checked_add(1)
            .unwrap();
    ...
    // Event
    let event: FillClaimedCollectionAssetDistributionEvent =
        FillClaimedCollectionAssetDistributionEvent {
            timestamp,
